...
function App() {
  ...
  const baseURL = "https://localhost:7098/api/alunos";
      ...
      <Modal isOpen={modalincluir} >
            ...
            <ModalBody>
              <div className="form-group">
                  ...
                  <label>Email:</label>
                  <br></br>
                  <input type="text" className="form-control" name="Emal" onChange ={handleChange}></input>
                  <label>Idade:</label>
                  <input type="text" className="form-control" name="9idade" onChange={handleChange}></input>
                  <br></br>
              </div>
            </ModalBody>
            <ModalFooter>
